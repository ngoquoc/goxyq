...
var moduleName = "[Logger Util]"

// InitLogToStdoutDebug function
...
// InitLogToStdouWarning function
...
func Init(logLevel string) {
	...
	logrus.Info(moduleName + "[Init]" + "Logger Initialized with value " + logLevel)
}
